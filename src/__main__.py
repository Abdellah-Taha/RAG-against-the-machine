import argparse
import time
from search_dataset import retrieve_questions, review_results, retrieve_question_id
...
def main():
    ...
    search_results = total_search_results(questions, question_ids, args.k, meta_data=meta_data)
